...
## 無法選擇文字按鈕時使用的顏色
define gui.insensitive_color = '#ffffffc3'
...
define gui.choice_button_text_hover_color = "#56160f"
define gui.choice_button_text_insensitive_color = '#706666d8'
...
## 如何處理 gui 中不可滾動的捲軸。 "hide" 隱藏它們，而 None 則顯示它們
